  ...
  return (
    <Article>
      <Section plain>
        ...
        <p>
          Analog.Cafe lets you compose and edit your submission, even if you are
          offline using a tool called <em>Composer</em>.
        </p>
        <p>
          We recommend that you use latest Google Chrome, Safari or Firefox
        ...
        <p>
          ...
          first submission it will appear here with a status sown next to it. As
          with most publications, not all submissions can be accepted.
        </p>
        <Figure
        ...
        />
        <p>
          While composing your submission keep in mind that it has to have a
        ...
        <p>
          ...
          or social media page. Just click on “More…” in the naviagation bar of
          this website to find what you need.
        </p>
        <LinkButton
          to={
